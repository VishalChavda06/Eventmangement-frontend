    ...
    <div className="card overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="mb-3 flex flex-wrap items-center gap-2">
          ...
          <span
            className={`rounded-full px-3 py-1 text-xs font-semibold ${event.status === "cancelled" ? "bg-red-100 text-red-700" : event.status === "completed" ? "bg-slate-100 text-slate-700" : event.status === "ongoing" ? "bg-emerald-100 text-emerald-700" : "bg-blue-100 text-blue-700"}`}
          >
